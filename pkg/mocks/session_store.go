...
// Source: github.com/saas/hostgolang/pkg/session (interfaces: Store)
...
func (m *MockStore) Get(arg0 string) (*types.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Put(arg0 string, arg1 *types.Account) error {
	m.ctrl.T.Helper()
