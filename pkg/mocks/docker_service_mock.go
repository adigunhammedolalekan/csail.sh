...
// BuildImageFromGitRepository mocks base method
func (m *MockDockerService) BuildImageFromGitRepository(arg0 context.Context, arg1, arg2 string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BuildImageFromGitRepository", arg0, arg1, arg2)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// BuildImageFromGitRepository indicates an expected call of BuildImageFromGitRepository
func (mr *MockDockerServiceMockRecorder) BuildImageFromGitRepository(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BuildImageFromGitRepository", reflect.TypeOf((*MockDockerService)(nil).BuildImageFromGitRepository), arg0, arg1, arg2)
}
